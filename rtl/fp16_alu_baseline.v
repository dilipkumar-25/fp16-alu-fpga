...
module fp16_alu_baseline #(
    ...
    localparam NAN_OUT  = {1'b0,{EXP_WIDTH{1'b1}},
    ...
    wire [MANT_WIDTH:0]   mfull_a = (exp_a==EXP_ZERO)
                                    ? {1'b0,mant_a}
                                    : {1'b1,mant_a};
    ...
    wire [MANT_WIDTH:0]   mfull_b = (exp_b==EXP_ZERO)
                                    ? {1'b0,mant_b}
                                    : {1'b1,mant_b};
    ...
    wire [MANT_WIDTH:0]   mfull_a2 = (exp_a2==EXP_ZERO)
                                     ? {1'b0,mant_a2}
                                     : {1'b1,mant_a2};
    ...
    wire [MANT_WIDTH:0]   mfull_b2 = (exp_b2==EXP_ZERO)
                                     ? {1'b0,mant_b2}
                                     : {1'b1,mant_b2};
    ...
    wire signed [EXP_WIDTH:0] actual_exp3 =
         $signed({1'b0,exp_a}) - BIAS;
        ...
        case (op_sel)
            ...
            4'b0000: begin
                if (a_is_nan||b_is_nan) begin
                    ...
                    if (a_is_inf&&b_is_inf&&(sign_a!=sign_b))
                        ...
                        comb_result = {(a_is_inf?sign_a:sign_b),
                                       EXP_ONES,
                                       {MANT_WIDTH{1'b0}}};
                    ...
                    if (exp_a >= exp_b) begin
                        ...
                        mant_b_al  = {mfull_b,2'b00}
                                     >>(exp_a-exp_b);
                    end else begin
                        res_exp    = exp_b;
                        res_sign   = sign_b;
                        mant_a_al  = {mfull_b,2'b00};
                        mant_b_al  = {mfull_a,2'b00}
                                     >>(exp_b-exp_a);
                    end
                    ...
                    if (sum_mant==0) begin
                        ...
                        comb_result = {res_sign,
                                       res_exp+1,
                                       sum_mant[MANT_WIDTH+2:3]};
                    end else begin
                        lzc=0;
            ...
            4'b0001: begin
                if (a_is_nan||b_is_nan) begin
                    ...
                    if (exp_a >= exp_b) begin
                        ...
                        mant_b_al2 = {mfull_b2,2'b00}
                                     >>(exp_a-exp_b);
                    end else begin
                        res_exp2   = exp_b;
                        res_sign2  = sign_b;
                        mant_a_al2 = {mfull_b2,2'b00};
                        mant_b_al2 = {mfull_a2,2'b00}
                                     >>(exp_b-exp_a);
                    end
                    ...
                    if (sum_mant2==0) begin
                        ...
                        comb_result = {res_sign2,
                                       res_exp2+1,
                                       sum_mant2[MANT_WIDTH+2:3]};
                    end else begin
                        lzc2=0;
            ...
            4'b0010: begin
                if (a_is_nan||b_is_nan) begin
                    ...
                    comb_result = {sign_a^sign_b,EXP_ONES,
                                   {MANT_WIDTH{1'b0}}};
                end else if (a_is_zero||b_is_zero) begin
                    comb_result = 0;
                end else begin
            ...
            4'b1011: begin
                if ((exp_a==EXP_ONES)||
                    (actual_exp3 >= DATA_WIDTH-1)) begin
                    comb_of     = 1;
                    comb_result = sign_a ? MAX_NEG : MAX_POS;
                end else if ((exp_a==EXP_ZERO&&mant_a==0)||
                             actual_exp3 < 0) begin
                    comb_result = 0;
                end else begin
